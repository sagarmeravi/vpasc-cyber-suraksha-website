        ...
        <div className="container mx-auto px-4">
              ...
              <Card key={post.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-6">
                  ...
                  <Button asChild variant="outline">
                    <Link href={`/blog/${post.id}`} className="bg-blue-600 hover:bg-orange-500 text-white">Read More</Link>
                  </Button>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="flex justify-center mt-12">
            <div className="flex space-x-1">
              ...
              <Button variant="outline" size="sm" className="text-white bg-blue-600">
                1
              </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <Button asChild>
                  <Link href="#" className="hover:bg-orange-500">Download PDF</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <Button asChild>
                  <Link href="#" className="hover:bg-orange-500">Download PPT</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
